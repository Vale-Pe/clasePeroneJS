...
export function nadar() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">El delfín podría ayudarte, pero también podría no hacerlo. Decides correr el riesgo de arreglarte por tu cuenta. Nadas en dirección a la superficie. El delfín te sigue un rato y luego se aleja. Te tomas un descanso a unos 9 metros por debajo de la superficie, antes de iniciar el ascenso final. <br>En ese momento ves que se acerca un pez enorme, feísimo, lleno de protuberancias, hinchado y cubierto de marcas negras y blancas. Fija en ti sus ojos saltones. Es un gran mero, un pez que no se molesta en morder a sus víctimas, pues se las traga enteras de un solo bocado. Evidentemente serás su próxima comida. <br><br><center><strong>FIN</strong></center></p>'
...
export function descender() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">Es el momento de tomar una decisión. Verificas todos los controles del submarino, aprietas los dientes y accionas la palanca de control hasta la posición de inmersión profunda. Desciendes hasta donde ninguna persona se ha aventurado nunca. El submarino es apropiado para bajar a grandes profundidades, pero ahora lo hace a toda velocidad. <br>La presión es intensa, la oscuridad total y el calibrador de profundidad marca una cifra increíble: 25 kilómetros. Inviertes de inmediato la palanca de control. En el panel parpadean las luces de advertencia: indican que ahora las fuerzas de gravitación son más potentes que los motores de propulsión del submarino. Has cruzado el punto de no retorno y tu viaje descendente continuará en la más profunda oscuridad hasta que la presión del agua sea excesiva para el submarino. Este es tu último viaje. <br><br><center><strong>FIN</strong></center></p>'
