...
export function volver() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">Piensas que es demasiado peligroso bucear en un hoyo profundo que puede conducir al centro de la tierra. Lo más sensato será volver a la superficie y trazar un plan de acción. <br>Echas una última mirada a la abertura, controlas los instrumentos del submarino e inicias el ascenso. Por fin la nave llega al aire fresco y a la luz del sol; aguardas hasta que el barco te recoge. <br><br>Para continuar presioná 1 o 2. </p>'
...
export function esforzarte() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">Estás mareado por la falta de oxígeno y por la fatiga. Con el cuchillo cortas las densas algas que te rodean. Vas liberándote poco a poco. Repentinamente sales disparado a través de los restos de algas marinas y asomas a la superficie. Disparas el cohete de señales y poco después te divisa la tripulación del barco. Al poco rato estás a bordo, sano y salvo, rodeado de amigos. ¡Qué alivio haber salido de aquel mundo de pesadilla! <br><br>Si al día siguiente vuelves a bucear presioná 1. Si descansas y esperas unos días para trazar un plan de emergencia presioná 2. </p>'
...
export function unirteANodores() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">    - Quiero ir con los nodores - le informas a tu guía. <br>El hombre barbudo te conduce a las afueras de la ciudad. <br>    - Ahora debemos separamos. Buena suerte. <br>Los nodores envían un destacamento de recepción fuertemente armado. Sospechan de ti y creen que eres un espía de los atlantes. Su aspecto es exactamente igual al de éstos, pero rara vez sonríen. <br>    - Ven. Tenemos que interrogarte. Quizá trabajarás para nosotros. <br>Durante tres días te interrogan, sin permitirte salir de una pequeña habitación sin ventanas. No son nada afables y sospechas que has cometido un error. Te piden que les ayudes a espiar a los atlantes. Insinúan que en tu condición de espía podrás pasar libremente de un grupo a otro. <br><br>Si decides escapar presioná 1. Si decides aceptar presioná 2. </p>'
...
export function quedarteConAtlantes() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">Decides quedarte con los atlantes. Su estilo de vida te parece ideal. Pasan el tiempo creando cosas en defensa de la vida y ninguna para destruirla. Te parece que su líder dice la verdad cuando insiste en que hay que evitar la guerra y no fomentar el odio. <br>Te fascina ese mundo aparentemente ideal. Quisieras quedarte para investigar la historia que llevó a la Atlántida a ser lo que es, y averiguar la causa de la escisión entre los atlantes y los nodores. No obstante, en el fondo de tu mente se asienta la esperanza de escapar para volver a tu propio mundo. <br><br>Si decides quedarte presioná 1. Si decides escapar presioná 2. </p>'
...
export function zoo() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">    - No, me niego tajantemente a una operación tan disparatada. ¡No quiero convertirme en un pez! <br>Los atlantes intentan convencerte de que la vida con ellos será dichosa, útil y prolongada. No obstante, te reusas. Te rocían con una neblina especial que te hace perder rápidamente el conocimiento. Varias horas después recuperas el sentido y te encuentras en un depósito submarino de aire en el que respiras con naturalidad. <br>Quizá cometiste un error enorme. Ya no quieren que te unas a su mundo ni que participes de su estilo de vida. Rechazaste su ofrecimiento y ahora estás preso en un zoológico. <br><br><center><strong>FIN</strong></center></p>'
