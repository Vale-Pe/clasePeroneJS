...
export function viajarET() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-4">¡Un viajero del pensamiento! Te das cuenta de que eso es lo que siempre hace la gente cuando sueña. Los atlantes te dicen serenamente que todo es igual: pasado, presente y futuro son lo mismo. Basta que te concentres y pongas tus pensamientos donde desees que estén. Lo intentas; sorprendentemente atraviesas el tiempo a gran velocidad hasta el día en que naciste, y luego hasta el día en que por primera vez hiciste submarinismo en alta mar. Tu mente vuela de un momento de tu vida a otro. Pero cuando decides pasar al futuro te encuentras ante un muro en blanco. Aparentemente no puedes viajar al futuro. <br>    - ¿Por qué no puedo adelantarme en el tiempo? - preguntas a los atlantes. <br>    - Ten paciencia - responden. - Cada cosa a su tiempo. <br>De repente giras a través del tiempo y sales a los confines exteriores del universo, donde sientes que la luz pasa a través de ti. No proyectas ninguna sombra. Te inunda una agradable sensación de paz. <br><br>Si decides quedarte presioná 1. Si decides esperar para tomar una decisión más meditada,  presioná 2. </p>'
