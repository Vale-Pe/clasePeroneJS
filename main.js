...
function validarJugador() {
    ...
    divEdad.innerHTML = '<p class="parrafo fs-3">¿Cuál es tu edad?</p><label for="inputEdad"><input type="number" id="inputEdad" class="input" placeholder="Edad: "></label>'

    divNombre.innerHTML = '<p class="parrafo fs-3">Introduce tu nombre, por favor.</p><label for="inputNombre"><input type="text" id="inputNombre" class="input" placeholder="Nombre: "></label>'
...
function validarDatos(evt) {
    ...
    if ((edad >=13) && !(nombre.length ===0)) { //--> baje edad. No tenia sentido que sea para > de 18
        ...
        divFormulario.innerHTML = '<button type="button" class="btnComienzo fs-3" value="comenzar">Comenzar juego</button>'
            ...
            .then ((dato) =>{
                dato.forEach(libro => {
                    ...
                    <div class="divLibros">
                        ...
                        <h4 class="parrafo fs-4"><p class="fs-4 mb-0">${libro.titulo}</p></h4>
...
export function mostrarFinal(evt){ //FINAL
    ...
    <form action="" class="formulario">
        <p class="parrafo fs-3">¡Gracias por jugar ${nombre}! </p>
    </form>`
}