...
export function permanecerInmovil() {
    ...
    divTexto = document.querySelector(".divTexto")
    divTexto.innerHTML = '<p class="parrafo fs-5">Esperas, inmóvil, a que el tiburón se aleje. Pero un rato después descubres que otros tiburones se acercan para participar de la cacería. Te rodean, cada vez más próximos, cada vez más rápidos. Es demasiado tarde. ¡No hay salida! <br><br><center><strong>FIN</strong></center></p>'
